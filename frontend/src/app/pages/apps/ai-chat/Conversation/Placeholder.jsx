...
export function Placeholder() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col pb-3 pt-12">
      <div className="px-4 text-[clamp(2rem,3vw,3rem)] font-medium leading-[1.1] tracking-tight">
        <span className="block animate-shimmer bg-linear-to-r from-violet-400 via-red-400 to-fuchsia-400 bg-clip-text font-semibold text-transparent">
          Hola
        </span>
